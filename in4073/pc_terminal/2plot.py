...
class SubplotAnimation(animation.TimedAnimation):
    def __init__(self):
        ...
        self.line_mode = Line2D([], [], color=c0)
        self.ax_mode.add_line(self.line_mode)
        self.line_voltage = Line2D([], [], color=c0)
        self.ax_voltage.add_line(self.line_voltage)
        self.line_pressure = Line2D([], [], color=c0)
        self.ax_pressure.add_line(self.line_pressure)
        self.line_temp = Line2D([], [], color=c0)
        self.ax_temp.add_line(self.line_temp)
        self.line_pr0 = Line2D([], [], color=c0)
        self.line_pr1 = Line2D([], [], color=c1)
        self.line_pr2 = Line2D([], [], color=c2)
        self.line_pr3 = Line2D([], [], color=c3)
        self.line_pr4 = Line2D([], [], color=c4)
        ...
        self.line_x = Line2D([], [], color=c1)
        self.line_y = Line2D([], [], color=c2)
        self.line_z = Line2D([], [], color=c3)
        self.lines_pos = [self.line_x, self.line_y, self.line_z]
        for l in self.lines_pos:
            self.ax_pos.add_line(l)
        self.line_u = Line2D([], [], color=c1)
        self.line_v = Line2D([], [], color=c2)
        self.line_w = Line2D([], [], color=c3)
        ...
        self.line_lift  = Line2D([], [], color=c1)
        self.line_roll  = Line2D([], [], color=c2)
        self.line_pitch = Line2D([], [], color=c3)
        self.line_yaw   = Line2D([], [], color=c4)
        ...
        self.line_ae1 = Line2D([], [], color=c1)
        self.line_ae2 = Line2D([], [], color=c2)
        self.line_ae3 = Line2D([], [], color=c3)
        self.line_ae4 = Line2D([], [], color=c4)
        ...
        self.line_phi   = Line2D([], [], color=c1)
        self.line_theta = Line2D([], [], color=c2)
        self.line_psi   = Line2D([], [], color=c3)
        self.lines_att = [self.line_phi, self.line_theta, self.line_psi]
        for l in self.lines_att:
            self.ax_att.add_line(l)
        self.line_p = Line2D([], [], color=c1)
        self.line_q = Line2D([], [], color=c2)
        self.line_r = Line2D([], [], color=c3)
        self.lines_spin = [self.line_p, self.line_q, self.line_r]
        for l in self.lines_spin:
            self.ax_spin.add_line(l)
        self.line_L = Line2D([], [], color=c1)
        self.line_M = Line2D([], [], color=c2)
        self.line_N = Line2D([], [], color=c3)
        self.lines_torque = [self.line_L, self.line_M, self.line_N]
        for l in self.lines_torque:
            self.ax_torque.add_line(l)
        self.line_sp = Line2D([], [], color=c1)
        self.line_sq = Line2D([], [], color=c2)
        self.line_sr = Line2D([], [], color=c3)
        self.lines_sp = [self.line_sp, self.line_sq, self.line_sr]
        for l in self.lines_sp:
            self.ax_sp.add_line(l)
        self.line_sax = Line2D([], [], color=c1)
        self.line_say = Line2D([], [], color=c2)
        self.line_saz = Line2D([], [], color=c3)
    ...
    def _draw_frame(self, framedata):
        ...
        for ax in ([self.ax_temp, self.ax_pressure, self.ax_voltage, self.ax_prof] + self.axes_2 + self.axes_3):
            ax.relim()
